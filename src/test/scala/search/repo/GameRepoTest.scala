...
object GameRepoTest extends ZIOSpecDefault with NarrowIntegrationSuite:
  ...
  def spec =
    suite("GameRepo")(
      ...
      suite("save")(
        test("should put all game into database even if there are more than 25 games in the query (this ia a limitation of the dynamodb, we should overcome that using streams under the hood)") {
